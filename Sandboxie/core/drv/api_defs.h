...
enum {
    ...
    API_CAPTURE_READ,
    API_CAPTURE_MAP,
    API_CAPTURE_READ_PACKETS,
    API_CAPTURE_READ_STREAMS,
...
#define CAPTURE_DRIVER_FLAG_INCLUDE_PAYLOAD     0x00000004
...
#define CAPTURE_DRIVER_MAX_READ_PACKETS         32
#define CAPTURE_DRIVER_MAX_READ_STREAMS         32
...
typedef struct _CAPTURE_DRIVER_MAP {
...
typedef struct _CAPTURE_DRIVER_PACKET_READ {
...
} CAPTURE_DRIVER_PACKET_READ;


typedef CAPTURE_DRIVER_PACKET_READ CAPTURE_DRIVER_STREAM_READ;
...
#define CAPTURE_DRIVER_PACKET_READ_BASE_SIZE \
    ((ULONG)FIELD_OFFSET(CAPTURE_DRIVER_PACKET_READ, records))
...
C_ASSERT(sizeof(CAPTURE_DRIVER_MAP) == 48);
C_ASSERT(CAPTURE_DRIVER_READ_BASE_SIZE == 72);
C_ASSERT(CAPTURE_DRIVER_PACKET_READ_BASE_SIZE == 72);
C_ASSERT(sizeof(CAPTURE_DRIVER_PACKET_READ) ==
...
API_ARGS_BEGIN(API_CAPTURE_MAP_ARGS)
API_ARGS_FIELD(CAPTURE_DRIVER_MAP *,map)
API_ARGS_CLOSE(API_CAPTURE_MAP_ARGS)


API_ARGS_BEGIN(API_CAPTURE_PACKET_READ_ARGS)
API_ARGS_FIELD(CAPTURE_DRIVER_PACKET_READ *,read)
API_ARGS_FIELD(ULONG,read_size)
API_ARGS_CLOSE(API_CAPTURE_PACKET_READ_ARGS)


API_ARGS_BEGIN(API_CAPTURE_STREAM_READ_ARGS)
API_ARGS_FIELD(CAPTURE_DRIVER_STREAM_READ *,read)
API_ARGS_FIELD(ULONG,read_size)
API_ARGS_CLOSE(API_CAPTURE_STREAM_READ_ARGS)
